...
class TaskFormActivity : AppCompatActivity(), View.OnClickListener,
    ...
    private var taskIndetification = 0
    ...
    private fun loadDataFromActivity() {
        ...
        if (bundle != null) {
            taskIndetification = bundle.getInt(TaskConstants.BUNDLE.TASKID)
            viewModel.load(taskIndetification)
        }
    }
